...
public class StudentMapper {
    ...
    public StudentIndeksResponse fromStudentIndexToResponse(StudentIndeks si) {
        ...
        StudijskiProgramResponse studijskiProgramResponse = studijskiProgramMapper.toResponse(si.getStudijskiProgram());
        response.setStudijskiProgram(studijskiProgramResponse);
        StudentPodaciResponse sp = fromStudentPodaciToResponse(si.getStudent());
        response.setStudent(sp);
        return response;
    }
